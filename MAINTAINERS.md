...
- PRs touching security-critical paths (`firewall.py`, `dns.py`, `dns_resolved.py`, `ux.py`, `tor_control.py`, `selinux.py`, `watchdog/`, `commands/`, `.github/workflows/`) require explicit sign-off from the Project Lead.
